...
The native-distribution recovery uses TabPFN's predictive head. For a query
...
Quantile-inversion recovery queries the provider for a conditional quantile table
\[
